    ...
    <div>
        ...
        <div className='flex flex-col gap-4 m-5'>
          ...
          <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white '>
            ...
            <input type="checkbox" onChange={() => {if (isEdit) { setProfileData(prev => ({ ...prev, available: !prev.available }));}}}
            ...
            {
              isEdit 
              ?<button onClick={()=>updateProfile()} className='px-4 py-1 border border-purple-400 text-sm rounded-full mt-5 hover:bg-blue-500 hover:text-white transition-all '>Save</button>
              :<button onClick={()=>setIsEdit(true)} className='px-4 py-1 border border-purple-400 text-sm rounded-full mt-5 hover:bg-blue-500 hover:text-white transition-all '>Edit</button>
            }
